...
public class DruidManager {
    ...
    private static final String DB_PASSWORD = "zm2019.."; // 鏁版嵁搴撳瘑鐮�
    private static final String OLDSYS_URL = "jdbc:mysql://127.0.0.1:3306/course_info?characterEncoding=utf-8&useSSL=false&serverTimezone=UTC"; // 鏁版嵁搴撹繛鎺RL
    private static final String OLDSYS_USERNAME = "root"; // 鏁版嵁搴撶敤鎴峰悕
    private static final String OLDSYS_PASSWORD = "zm2019.."; // 鏁版嵁搴撳瘑鐮�
